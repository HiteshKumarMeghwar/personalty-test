<?php 
    ...
    if(isset($_SESSION['last_inserted_user_id'])){
       ...
       /*  $sql = "SELECT *
        ...
        $sql = "SELECT *
            FROM honesty 
            INNER JOIN questions_options ON honesty.id = questions_options.question_id 
            INNER JOIN OPTIONS ON questions_options.option_id = options.id
            INNER JOIN questions_core_values ON honesty.id = questions_core_values.question_id 
            INNER JOIN core_values ON questions_core_values.core_value_id = core_values.id
            WHERE user_id=".$last_inserted_user_id;
...
<?php
    ...
    $sql = "SELECT * FROM honesty ORDER BY RAND()";
    $result = $conn->query($sql);
