                    ...
                    <?php
                        ...
                        if (isset($_SESSION['result1'])) {
                            ...
                            while (isset($_SESSION['result'.$count]) && $_SESSION['result'.$count]) {
                                ...
                                ?>
                                    <div class="mt-5">
                                        <div class="d-style border-2 bgc-white btn-outline-purple btn-h-outline-purple btn-a-outline-purple w-100 my-2 py-3 shadow-sm">
                                            <!-- Premium Plan -->
                                            <div class="row align-items-center">
                                                <div class="col-12 col-md-8"> 
                                                ...
                                                <ul class="list-unstyled mb-0 col-12 col-md-4 text-dark-l1 text-90 text-left my-4 my-md-0">
                                                    <li class="mt-25">
                                                        ...
                                                        <label for="option-<?php echo $question_id ?>" class="text-110" style="font-family: cursive;">Strongly Agree
