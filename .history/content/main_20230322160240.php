                        ...
                        <div class="row align-items-center">
                            <div class="col-12 col-md-8"> 
                                <div class="text-secondary-d1 text-120" style="font-family: cursive; font-weight: bolder;">
                                    1  Honesty => <?php echo $_SESSION['honesty'] ?>
                                    2  Ownership => <?php echo $_SESSION['ownership'] ?>
                                    3  Teamwork => <?php echo $_SESSION['teamwork'] ?>
                                    4  Customer Experience => <?php echo $_SESSION['customer_experience'] ?>
