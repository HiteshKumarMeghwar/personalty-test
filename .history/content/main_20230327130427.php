            ...
            ?>
                <form method="post" action="content/my_process.php">
                    <div class="mb-3">
                        ...
                        <label for="exampleInputEmail1" class="form-label" style="font-family: cursive;"><span style="font-family: cursive; color: red; font-weight: bolder;">*</span>Full Name</label>
